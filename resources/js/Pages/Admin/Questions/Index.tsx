...
export default function QuestionsIndex() {
    ...
    return (
        <AdminLayout>
            ...
            {loading ? (
                <div className="flex items-center justify-center py-16"><div className="w-10 h-10 border-4 border-[#46178F] border-t-transparent rounded-full animate-spin" /></div>
            ) : (
